    ...
    <Block className={styles.block} contentClassName={null}>
        ...
        <Row>
          <Col xs={12} md={12}>
            <a href="https://junction2017.devpost.com/">
              <button className={styles.apply_button}> MORE PROJECTS</button>
            </a>
          </Col>
        </Row>
      </Block>
      <Block className={styles.block_dark}>
        ...
        <Row className={styles.imagerow}>
          <Col xs={6} md={6}>
            <img
              src="https://farm5.staticflickr.com/4685/38263127614_4ff826425d_k_d.jpg"
              className="responsive"
              alt=""
            />
          </Col>
          <Col xs={6} md={6}>
            <img
              src="https://farm5.staticflickr.com/4582/38092639625_dbf88e1147_k_d.jpg"
              className="responsive"
              alt=""
            />
          </Col>
