    ...
    <Row>
      <Col xsOffset={1} xs={11} md={5} className={styles.faqCell}>
        <FaqSection question="What is Junction?">
          <p>Junction is a converging point thousands of developers, designers, and entrepreneurs from around the world. In 2016, Junction provided the biggest hackathon experience in Europe by bringing together 1300 participants from over 70 countries.</p>
      ...
      <Col xsOffset={1} xs={11} md={5} className={styles.faqCell}>
        <FaqSection question="When and where can I apply?">
          <p>The application period will open on 1st September and close on 15th October 2017. Make sure to apply HERE!</p>
        </FaqSection>
      </Col>
      <Col xsOffset={1} xs={11} md={5} className={styles.faqCell}>
        <FaqSection question="Who are the people behind Junction?">
          <p>Junction is a non-profit organization completely run by volunteering students. We are super excited about entrepreneurship and tech events, and run multiple events throughout the year.</p>
        </FaqSection>
      </Col>
      <Col xsOffset={1} xs={11} md={5} className={styles.faqCell}>
