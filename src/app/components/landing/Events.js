  ...
  <Scroll.Element name="events">
    <Block className={styles.block}>
      ...
      <BlockHeader title="NOT JUST A HACKATHON">
        <p>
          Junction is much more than your standard hackathon. We are a worldwide community of ambitious creators. Check
          out our Speaker Day Hack\Talks and local-events around the world.
        </p>
      </BlockHeader>
      <Row>
        <Col xs={12}>
          <a href="http://hacktalks.hackjunction.com">
            <img
          ...
          <h3>HACK\TALKS</h3>
          <p>
            Hack\Talks is all about inspiring you. The evening will consist of intriguing keynotes and deep-tech
            learnings from industry experts. This is something you don’t want to miss.
          </p>
